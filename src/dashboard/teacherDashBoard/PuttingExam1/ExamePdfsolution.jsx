...
function ExamPdf_dash() {
                    ...
                    <div className="d-flex my-2 draggable" draggable="true">
                      {(markquestion.options).map((option, index) => (
                        <div className='' key={index} style={{fontSize:"21.33px",padding:"0px 80px"}}>
                          ...
                          <span>) </span>
                          {option.option}
                                    <span className='ms-1' style={{paddingLeft:"0px", color:"green"}}> {option.is_correct===1?"correct answer":"" } </span>
  ...
  <div key={div.id}>
      ...
      className="fas fa-xmark mt-3 px-3"
...
{/* //////////////////////////////////////download///////////////////////////////////////////////////// */}
      ...
      <div dir="rtl" className="p-0 ">
        <div className='d-flex align-items-center justify-content-center p-5'>
          ...
          <Link to={"/ExamPdf"}>
            <button className="btn_putting_exam2_after text-white py-0 m-0 mt-3 mx-2 p-5" style={{backgroundColor:"#4941A6"}}>Questions page</button>
          </Link>
          <Link>
