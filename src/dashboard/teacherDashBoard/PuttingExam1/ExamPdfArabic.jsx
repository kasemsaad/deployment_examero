    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid black', width:"1145px"
        }}
        dir="rtl"
      >
      ...
      <div dir="rtl" className="p-0 ">
        <div className='d-flex align-items-center justify-content-center p-5'>
          ...
          <Link to={"/ExamPdfArabicsolution"}>
            <button className="btn_putting_exam2_after text-white py-0 m-0 mt-3 mx-2 p-5" style={{backgroundColor:"#4941A6"}} >صفحه الإجابات</button>
          </Link>
          <Link>
